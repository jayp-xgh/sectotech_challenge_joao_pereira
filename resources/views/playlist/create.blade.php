...
<body class="bg-[#242933]">
    ...
    <form method="post" action="{{ route('playlist.store') }}" class="w-3/5 flex items-start justify-items-start flex-col justify-start gap-3 mt-10 h-[80%] container">
        
        @csrf
        @method('post')

        <h1 class="mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Create Playlist</h1>
